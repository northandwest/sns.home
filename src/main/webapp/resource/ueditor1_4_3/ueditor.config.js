...
(function() {
	...
	// 服务器统一请求接口路径
	,
	serverUrl : ulewo.absolutePath + "/resource/ueditor1_4_3/config.json"

	// 工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
	,
	toolbars : [ [ 'undo', 'redo', '|', 'bold', 'italic', 'underline', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', '|', 'fontfamily', 'fontsize', 'justifyleft',
		'justifycenter', 'justifyright', '|', 'link', 'unlink', 'insertimage', 'emotion', 'insertvideo', 'music', 'insertcode', '|', 'inserttable'] ]
