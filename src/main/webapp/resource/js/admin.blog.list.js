...
function initPage(pageNo) {
	...
	ulewo.ajaxRequest({
		...
		if (list.length > 0) {
			...
			$("<tr><td valign='center'><a href='"+ulewo.absolutePath+"/user/"+ulewo.user.userId+"/blog/"+d.blogId+"' target='_blank'>"+d.title+"</a></td><td>"+d.commentCount+"</td><td>"+d.readCount+"</td><td>"+d.showCreateTime+"</td><td>" + edit + "</td></tr>").appendTo($("#data-list"));
		    }
		} else {
